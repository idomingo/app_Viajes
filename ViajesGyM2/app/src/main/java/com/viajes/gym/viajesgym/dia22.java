...
public class dia22 extends FragmentActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thumb1View.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                zoomImageFromThumb(thumb1View, R.drawable.viena3);
            }
        });
        ...
        thumb2View.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                zoomImageFromThumb(thumb2View, R.drawable.buda1);
            }
        });
        ...
        thumb3View.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                zoomImageFromThumb(thumb3View, R.drawable.buda2);
            }
        });
