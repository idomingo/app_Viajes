...
/**
 * Created by RoTaM on 14/02/2017.
 */
...
public class dia19 extends FragmentActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View thumb1View = findViewById(R.id.thumb_button_2);
        thumb1View.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                zoomImageFromThumb(thumb1View, R.drawable.pragametro);
            }
        });
/*
        ...
        thumb2View.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                zoomImageFromThumb(thumb2View, R.drawable.praga1);
            }
        });
        ...
        thumb3View.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                zoomImageFromThumb(thumb3View, R.drawable.praga2);
            }
        });
